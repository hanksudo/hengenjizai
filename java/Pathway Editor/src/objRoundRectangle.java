...
public class objRoundRectangle extends objDrawModel {
	// 設置元件的長和寬
	static int thisWidth = 60;
	static int thisHeight = 30;
	
	private static RoundRectangle2D.Double obj = new RoundRectangle2D.Double(0, 0, thisWidth, thisHeight, 25, 25);
	private static Shape proximityObj = (new BasicStroke(DRAWMODEL_PROXIMITY_RADIUS)).createStrokedShape(obj);
	
	public objRoundRectangle(double positionXinput, double positionYinput) {
	...
	public void paintComponent(Graphics g) {
		...
		// 元件顏色
		g2.setColor(ROUNDRECTANGLE_COLOR);
